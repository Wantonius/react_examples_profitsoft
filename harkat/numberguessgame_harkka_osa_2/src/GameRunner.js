...
export default class GameRunner extends React.Component {
	...
	//TODO: Muu osa statesta siirtyy StateProvideriin paitsi currentGuess. 
	// Muokkaa tänne uusi submit funktio arvausformille siten, että se kutsuu
	// propsien kautta StateProviderissa olevaa guess funktiota.
	// Muista ottaa GameManager decorator käyttöön!
